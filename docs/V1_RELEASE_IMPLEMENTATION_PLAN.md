...
- [x] **V1-I.11 Add per-workspace toolchain binding.** Store the recommended and selected versions separately; restarting Typstry must restore the workspace selection without unexpectedly changing other projects.
- [x] **V1-I.12 Add menus and progress UI.** File menu actions: **Import Typstry Project**, **Export Typstry Project**, and **Export Source ZIP**. Use the `*.typstry` filter for version-bound projects. Downloads, validation, extraction, and cleanup must be cancellable where safe.
