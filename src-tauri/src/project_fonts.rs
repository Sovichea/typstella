...
pub fn build_package(
    ...
    let package = workspace.join(".typstry").join("fonts").join("package");
    ...
    for name in required {
        ...
        let generated_source = source
            .replace('\\', "/")
            .contains("/.typstry/fonts/generated/");
        ...
        records.push(PackagedFontRecord {
            ...
            path: format!(".typstry/fonts/package/{file_name}"),
            sha256: hash,
...
pub fn verify_package_files(
    ...
    let directory = workspace.join(".typstry").join("fonts").join("package");
    let mut total = 0_u64;
...
mod tests {
    ...
    fn rejects_unknown_and_corrupt_font_formats() {
        ...
        let package = workspace.path().join(".typstry/fonts/package");
        ...
        let manifest = FontPackageManifest {
            ...
            fonts: vec![PackagedFontRecord {
                ...
                weight: 400,
                stretch: 100,
                path: ".typstry/fonts/package/bad.ttf".into(),
