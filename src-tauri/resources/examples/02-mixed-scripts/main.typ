...
This document demonstrates several writing systems in one source file. Typstry can detect missing script coverage and let you choose an installed or downloadable fallback font.
