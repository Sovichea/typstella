...
A research document is larger than its currently open source file. This chapter is deliberately stored separately while `main.typ` remains the document entry point. In Typstry, opening this file keeps the full-document preview unless this first-line standalone directive is present.
...
#figure(
  image("../assets/typstry-icon.png", width: 18%),
